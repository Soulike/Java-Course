...
public class BitWriter
{
     ...
     * @throws IOException is thrown if the file does not exist or is not writable
     */
     ...
     * @throws IOException Throws an IOException if there were any problems writing to this file
     */
     ...
     * @param bit
     * @throws IOException         Throws an IOException if there were any problems writing to this file
     * @throws InvalidBitException An exception I made up to indicate that you are not using this method correctly..
     */
